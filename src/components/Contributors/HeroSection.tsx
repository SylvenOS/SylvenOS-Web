  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen px-6 md:px-[8%] py-[100px] overflow-hidden text-[var(--text)] flex items-center">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, var(--primary) 0%, var(--info) 50%, transparent 100%)",
        }}
      />
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, var(--logo) 0%, transparent 100%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--info)] via-[var(--primary)] to-[var(--logo)]">
              Sylven OS
            </span>
          </motion.h1>
          ...
          >
            Every project, document, design, and idea is made possible by
          ...
          >
            <motion.div variants={textItemVariants}>
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full sm:w-auto px-8 py-4 rounded-[var(--radius-sm)] bg-[var(--primary)] text-sm font-bold tracking-wide text-white transition-all duration-[var(--transition-fast)] focus:outline-none shadow-[var(--shadow-md)] cursor-pointer"
              >
